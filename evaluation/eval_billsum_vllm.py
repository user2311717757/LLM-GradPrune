...
if __name__ == '__main__':
    ...
    with open("/mnt2/name_prune/data/billsum_test_acl.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    label_list = []
    ...
    dataset = load_dataset(['/mnt2/name_prune/data/billsum_test_acl.json'], strict=False, seed=42)[0]
    ...
    print("#############all score billsum#############",(sum(F1)/len(F1)+sum(rouge_f1)/len(rouge_f1))/2)
