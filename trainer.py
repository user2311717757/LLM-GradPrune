            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    for name, param in model.named_parameters():
                       if 'lora_A' in name:
                           lora_a[name] = param.grad
                       if 'lora_B' in name:
                           lora_b[name] = param.grad
                    torch.save(lora_a,f'/prune/lora_grad_mistral/lora_grade_billsum/lora_grad_lora_a_step{step}_llama.pth')
                    torch.save(lora_b,f'/prune/lora_grad_mistral/lora_grade_billsum/lora_grad_lora_b_step{step}_llama.pth')
